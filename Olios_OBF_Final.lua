...
-- ===== LOAD UI (KHÔNG task.spawn) =====
    -- MENU + FARM Ở ĐÂY
local v14 = loadstring(game:HttpGet("https://raw.githubusercontent.com/dawid-scripts/Fluent/master/main.lua"))()
local v15 = v14:CreateWindow({
    Title = "FaFa Beta Hub-Blox Fruit [ Premium ]",-- olios
    Subtitle = "By Olios",-- 
    TabWidth = 160,
    Theme = "Dark",--
    Acrylic = false,
...
v23.Draggable = true;
v23.Image = "http://www.roblox.com/asset/?id=70659728963924";
...
v16.Home:AddButton({
    ...
    Callback = function()
        setclipboard("tiktok.com/@hoc.codedep.python");
    end
});
v16.Home:AddButton({
    Title = "Zalo Group",
    Description = "Click(Copy)",
    Callback = function()
        setclipboard("https://zalo.me/g/vzubrk519");
    end
});
v16.Home:AddButton({
    Title = "Remember:",
    Description = "This real Olios Hub, but a new version made by Olios Roblox.",
    Callback = function()
        setclipboard("tiktok.com/@hoc.codedep.python");
    end
});
...
if Sea3 then
    ...
    function UpdateIslandKisuneESP()
        for v682, v83 in pairs(game:GetService("Workspace")['_WorldOrigin'].Locations:GetChildren()) do
            pcall(function()
