...
v23.Draggable = true;
v23.Image = "http://www.roblox.com/asset/?id=73437569566986";
...
v16.Home:AddButton({
    ...
    Callback = function()
        setclipboard("https://www.tiktok.com/@ngu_roblox?_t=ZS-8ywjDgNQ1ah&_r=1");
    end
});
v16.Home:AddButton({
    Title = "Zalo Group",
...
v16.Home:AddButton({
    Title = "Remember:",
    Description = "This real Banana Cat Hub, but a new version made by Ngu Roblox.",
    Callback = function()
